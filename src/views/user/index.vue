<template>
  <n-card :bordered="false" class="proCard">
    ...
    >
      ...
      <n-form-item label="日期范围" path="phone">
        <n-date-picker
          ...
          @update:value="paramsDateChange"
        />
      </n-form-item>
      <n-space>
        <n-button type="info" @click="reloadTable">搜索</n-button>
        <n-button @click="resetParams">重置</n-button>
      </n-space>
    </n-form>
    <n-button type="info" ghost @click="addUser">新增</n-button>
    <BasicTable
      :toolbarShow=false
      :columns="columns"
    ...
    <n-modal v-model:show="editControl.editShow" 
          ...
          <n-grid style="width:100%" x-gap="12" :cols="2">
            ...
            <n-gi>
              <n-form-item label="用户性别" path="gender">
                <n-select
                  v-model:value="editInfo.gender"
                  placeholder="选择性别"
                  :options="editControl.genderOptions"/>
              </n-form-item>
            </n-gi>
          </n-grid>
          <n-grid style="width:100%" x-gap="12" :cols="2">
          ...
          <n-grid style="width:100%" x-gap="12" :cols="1">
            <n-gi>
              <n-form-item label="备注" path="remarks">
                <n-input
                  v-model:value="editInfo.remarks"
                  placeholder="请输入备注"
                  type="textarea"
                  :autosize="{
                    minRows: 3,
    ...
    <n-modal v-model:show="disRole.show" 
        preset="dialog" title="Dialog"
        :mask-closable="false"
        style="width:300px">
      <template #header>
...
<script lang="ts" setup>
  ...
  import { getUserList,addUserRequest,deleteUserRequest,
    editUserRequest,setUserStatusRequest,setUserRoleRequest } from '@/api/system/user';
